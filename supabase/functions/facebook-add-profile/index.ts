...
async function performFullSync(
  ...
  // ========== STAGE 2: SKIPPED ==========
  // Pages are NOT synced automatically. They will be synced via the browser extension
  // or manually when the user clicks "Sincronizar páginas" on the Pages screen.
  console.log("=== STAGE 2 SKIPPED: pages sync is manual/extension-only ===");
  await reportTaskStep(svcClient, taskId, 7, "syncingPages", "Páginas: sincronização manual (pulada)", {
    skipped: true,
  });
